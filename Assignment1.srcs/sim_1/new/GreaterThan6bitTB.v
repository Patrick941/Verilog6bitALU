...
// 
// Create Date: 12.03.2023 13:17:25
...
module GreaterThan6bitTB;
   ...
   GreaterThan6bit GTComparatorUnit (.vector0(testVector0), .vector1(testVector1), .GreaterThan(GreaterThanResult));
